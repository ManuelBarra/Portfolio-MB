...
export function Hero({ resume }: HeroProps) {
  ...
  return (
    <div ref={containerRef} style={{ maxWidth: '460px', width: '100%' }}>
      {/* Name */}
      <h1
        ref={nameRef}
        style={{
      ...
      >
        {personal.firstName}
        <br />
        <span style={{ color: 'var(--color-primary)' }}>{personal.lastName}</span>
      </h1>
      ...
      {/* Links */}
      <div ref={linksRef} style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', opacity: 0 }}>
      ...
      >
        <span style={{ color: 'var(--color-primary)' }}>↓</span> Scroll para más
      </p>
    </div>
  )
}
